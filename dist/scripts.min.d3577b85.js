...
},{"process":"pBGv"}],"o6ix":[function(require,module,exports) {
var define;
...
(function (e) {
  ...
  var x = window.MutationObserver || window.WebKitMutationObserver || !1,
    ...
    var B = function B(a, g, c, d, f, e, h) {
      this.st = a;
      this.ed = g;
      this.spd = c;
      this.p1 = d || 0;
    ...
    this.init = function () {
      ...
      if (!a.ispage || !f.cantouch && !f.isieold && !f.isie9mobile) {
        ...
        a.ispage ? (l.css({
          ...
          top: 0
        }), b.append(m))) : (a.isfixed = "fixed" == a.win.css("position"), b = a.isfixed ? "fixed" : "absolute", a.isfixed || (a.viewport = a.getViewport(a.win[0])), a.viewport && (a.body = a.viewport, 0 == /fixed|absolute/.test(a.viewport.css("position")) && a.css(a.viewport, {
          position: "relative"
        })), l.css({
          position: b
        }), a.zoom && a.zoom.css({
        ...
        if (f.isie9mobile) a.scrollmom = new M(a), a.onmangotouch = function () {
          ...
          if (0 != Math.round(Math.sqrt(Math.pow(f, 2) + Math.pow(g, 2)))) {
            ...
            80 < e - a.mangotouch.tm || a.mangotouch.dry != d || a.mangotouch.drx != l ? (a.scrollmom.stop(), a.scrollmom.reset(c, b), a.mangotouch.sy = b, a.mangotouch.ly = b, a.mangotouch.sx = c, a.mangotouch.lx = c, a.mangotouch.dry = d, a.mangotouch.drx = l, a.mangotouch.tm = e) : (a.scrollmom.stop(), a.scrollmom.update(a.mangotouch.sx - f, a.mangotouch.sy - g), a.mangotouch.tm = e, g = Math.max(Math.abs(a.mangotouch.ly - b), Math.abs(a.mangotouch.lx - c)), a.mangotouch.ly = b, a.mangotouch.lx = c, 2 < g && (a.mangotouch.lazy = setTimeout(function () {
              a.mangotouch.lazy = !1;
              a.mangotouch.dry = 0;
              a.mangotouch.drx = 0;
              a.mangotouch.tm = 0;
            ...
            a.ontouchstart = function (b) {
              ...
              if (!a.railslocked) {
                ...
                if (!f.cantouch && !this.istouchcapable && !b.pointerType) {
                  if (!c || !/INPUT|SELECT|TEXTAREA/i.test(c.nodeName)) return !a.ispage && f.hasmousecapture && c.setCapture(), a.opt.touchbehavior ? (c.onclick && !c._onclick && (c._onclick = c.onclick, c.onclick = function (b) {
...
$(".wrap-grids__item").click(function () {
  $(".frame-wrap, .myframe").show(), $("body").addClass("hidden-y");
}), $("#close-frame").click(function () {
  $(".frame-wrap").hide(300), $("body").removeClass("hidden-y");
});
},{"jquery":"juYr"}]},{},["o6ix"], null)